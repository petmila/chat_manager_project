...
from manager_app.models import Chat, EmployeeAccount, Message, ChatSource, ModelResponse
...
class TaskScheduleTestCase(TestCase):
    ...
    # def test_create_task_schedule__created(self):
    #     """"""
    #     TaskSchedule.objects.create(
    #         content_chat=,
    #         source_chat_id=1342468345,
    #         next_run_time=,
    #         time_period_in_hours=,
    #         interval_hours=,
    #         timestamp=,
    #     )
    #     task = TaskSchedule.objects.filter(name="chat_3").first()
    #     self.assertEqual(ChatSource.mattermost, chat.chat_source)
    #     self.assertEqual('1342468220', chat.source_chat_id)
