...
from manager_app.views import (ModelResponseListView, ModelResponseDetailView, PeriodicTaskView,
                               ...
                               MessagesByDateView, ModelResponseByDateView, LlamaTestView, ChatListView, ChatsByEmployeeNicknameView)
...
urlpatterns = [
    ...
    path("chats-detail/<str:name>/", ChatDetailView.as_view(), name="chats-detail"),
